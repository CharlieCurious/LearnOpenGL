...
int main(int argc, char **argv) {
    ...
    getSourceFilePath(vertexShaderPath, 256, argv[1], "6.1.coordinate_systems.vs");
    
    char fragmentShaderPath[256];
    getSourceFilePath(fragmentShaderPath, 256, argv[1], "6.1.coordinate_systems.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // retrive matrix uniform locations
